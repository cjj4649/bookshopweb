...
export default new Router({
  routes: [
    ...
    //   name: 'img',
    //   path: '/img',
    //   component: () => import(/* webpackChunkName: "userLogin" */ '@/components/i-img.vue')
    // },
    {
      name: 'userLogin',
      path: '/userLogin',
      component: () => import(/* webpackChunkName: "userLogin" */ '@/pages/userLogin.vue')
    },
    {
      name: 'img',
      path: '/imgload',
      component: () => import(/* webpackChunkName: "img" */ '@/components/i-img.vue')
    },
    {
      name: 'home',
      path: '/home',
